...
namespace Taxi.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("HESC123", "Crs", "Hdz", "cristofer@yopmail.com", "55 6666 7777", "México", UserType.Admin);
            UserEntity driver = await CheckUserAsync("2020", "Pedro", "Páramo", "pedro@yopmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.Driver);
            UserEntity user1 = await CheckUserAsync("3030", "Alejandro", "Magno", "alejandro@yopmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
            UserEntity user2 = await CheckUserAsync("4040", "Sor Juana", "De la cruz", "juana@yopmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
